...
1. You choose any one number between 1 and 63 (secretly).
2. The program displays 6 cards.
3. For each card:
   - If your number appears in the card → type 'y'
   - If not → type 'n'
4. Based on your answers, the program calculates your number using hidden binary logic.
5. Your number is revealed at the end.
...
1. Select any 1 number from the first card and keep it in mind.
2. You will be shown cards. If your number appears, type 'y'. If not, type 'n'.
3. Your number will be revealed based on your answers.
